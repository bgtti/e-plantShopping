...
function ProductList({ onHomeClick }) {
    ...
    const totalQuantity = useSelector((state) => state.cart.totalQuantity); //Retrieve the quantity of all the items in the cart from the Redux store.
    ...
    const handleAddToCart = (product) => {
        dispatch(addItem(product)); // dispatched the addItem
        ...
        <div>
            ...
            {!showCart ? (
                ...
                <CartItem onContinueShopping={handleContinueShopping}
                    onRemoveFromCart={handleRemoveFromCart}  // callback
                />
            )}
        </div>
    );
